...
const lights = [
    ...
    { label: "Torch", icon: "fas fa-fire", light: { dim: 30, bright: 15, color: "#ffae3d", alpha: 0.5, angle: 360, animation: { type: "torch", speed: 2, intensity: 1 } } },
    ...
    { label: "Bullseye Lantern", icon: "fas fa-bullseye", light: { dim: 90, bright: 45, color: "#ffa200", alpha: 0.5, angle: 45, animation: { type: "torch", speed: 3, intensity: 3 } } },
    { label: "Hooded Open", icon: "fas fa-lightbulb", light: { dim: 45, bright: 20, color: "#ffa200", alpha: 0.5, angle: 360, animation: { type: "torch", speed: 3, intensity: 3 } } },
